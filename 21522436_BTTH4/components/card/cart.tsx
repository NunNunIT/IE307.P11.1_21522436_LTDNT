  ...
  ({ id, productId, removeItem, quantity, onUpdateTotal }) => {
    ...
    return (
      <View
        ...
        className="w-full flex flex-col rounded-lg bg-white shadow dark:bg-zinc-900 p-5 mb-3"
      >
        <TouchableOpacity
          onPress={() =>
            router.push(
        ...
        >
          <Image
            ...
            className="aspect-square w-1/4 object-contain bg-white mr-2"
            resizeMode="contain"
          />
          <View className="w-2/3 p-2 flex flex-col items-start justify-between">
            <Text className="line-clamp-2 pt-2 text-left font-semibold text-wrap">
              {productData?.title || "Tên sản phẩm"}
            </Text>
            <Text className="font-semibold text-red-500 text-left">
        ...
        <View className="flex flex-col items-end !justify-between gap-2">
          ...
          <View className="flex flex-row items-center gap-2">
            ...
            <TextInput
              className="rounded-md border-2 border-zinc-200 dark:border-zinc-800 w-12 text-center"
              value={inputQuantity}
