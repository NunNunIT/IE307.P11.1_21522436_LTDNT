  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <View className="flex flex-row justify-between flex-wrap gap-2 px-2">
          {products.slice(0, 6).map((product, index) => (
            <ProductCard key={index} data={product} width={"w-[47%]"} />
          ))}
        </View>
      )}
      ...
      <Image
        ...
        className="w-full h-36 object-contain mt-8"
      />
      ...
      {loading ? (
        ...
        <View className="flex flex-row flex-wrap gap-2 px-2 justify-between">
